"""Auto-generated lazy exports for the components subsystem."""
...
_EXPORT_TARGETS: dict[str, str] = {
    "_load_layout_style_class": "ornata.components.base:_load_layout_style_class",
    "ButtonComponent": "ornata.components.button:ButtonComponent",
    "ContainerComponent": "ornata.components.container:ContainerComponent",
    "InputComponent": "ornata.components.input:InputComponent",
    "TableComponent": "ornata.components.table:TableComponent",
    "TextComponent": "ornata.components.text:TextComponent",
}
