"""Auto-generated lazy exports for the cli subsystem."""
...
_EXPORT_TARGETS: dict[str, str] = {
    "build_parser": "ornata.cli.main:build_parser",
    "main": "ornata.cli.main:main",
}
...
def _load_target(name: str) -> object:
    ...
    if target is None:
        raise AttributeError(
            "module 'ornata.api.exports.cli' has no attribute {name!r}"
        )
