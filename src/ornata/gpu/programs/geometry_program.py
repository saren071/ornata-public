# file: programs/geometry_program.py
...
class GeometryProgram(ShaderProgramBase):
    def __init__(self, source: str | None = None) -> None:
        super().__init__(["geometry", "default.glsl"], source)

    def compile(self, backend: "GPUBackend") -> "CompilationResult":
        return self._compile_stage_shader(backend, "compile_geometry_shader", "Geometry")
